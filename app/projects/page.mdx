...
## [<Plaintext title="Know" />](https://github.com/ynbh/know)

Local hybrid search CLI that indexes personal files into chunk embeddings (persistent Chroma store) and ranks results using dense semantic search, BM25 lexical search, and RRF fusion.

- Engineered incremental indexing with a file-change cache and chunk deduplication, cutting re-index time 67%.
- Built with Python and Llama Index for a fully local, private search experience.
...
## [<Plaintext title="NoteRouter" />](https://github.com/ynbh/noterouter)
